"""
Convert selected protein in PDB format to fasta sequences file.
"""
...
def main():
    ...
    bar = IncrementalBar("Generating Fasta files...", max=len(pdb_list))
    ...
    for pdb_id in pdb_list:
        ...
        with open(os.path.join(output_dir, f"{pdb_id}.fasta"), "w") as f_out:
